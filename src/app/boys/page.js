...
export const metadata = {
  title: "Boys Program | Gilbert Air Strike",
  description: "Gilbert Air Strike boys flag football. Age groups from 8U through High School in Gilbert, Arizona.",
};
    ...
    <>
      ...
      <section style={{ padding: "64px 0 80px", background: "#f5f5f5" }} className="section-pad">
        <div style={{ maxWidth: 1200, margin: "0 auto", marginBottom: 48 }}>
          <div className="sec-label" style={{ color: "var(--red)", marginBottom: 12 }}>
            Age Groups
          </div>
          <h2 style={{
            ...
            FIND YOUR <span style={{ color: "var(--red)" }}>TEAM</span>
          </h2>
        </div>
        <AgeGroupGrid program="boys" />
      </section>
